...
gh secret set FRONTEND_URL --body "https://safestories-panel.vercel.app/"
gh secret set ALLOWED_ORIGINS --body "https://safestories-panel.vercel.app,http://localhost:5174,http://localhost:3004"
